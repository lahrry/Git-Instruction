...
<br>
Let's first clone this specific repository. You can follow how to clone looking at the terminal that I attached below. 
...
You can see the technical folder inside and we are going to use this for this task!
