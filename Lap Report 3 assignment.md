...
You can find the command outputed '9' because there is 9 lines that matches the pattern 'water'. 
...
You can find the command outputed '1' because there is only one line that matches the pattern 'Chris'. 
